-- ================================================================
-- COMPLETE ADMIN SETUP FOR ALL INDIAN STATES AND UNION TERRITORIES
-- ================================================================
-- This SQL creates admins table and adds admins for ALL 36 states/UTs
...
-- INSERT ALL ADMINS
-- ================================================================
-- Default password for all state admins: "admin123"
...
-- SUPER ADMIN (Access to all states)
...
-- ================================================================
-- Total Admins: 37
--   - 1 Super Admin (access all states)
--   - 28 State Admins (for 28 states)
--   - 8 UT Admins (for 8 union territories)
--
-- Default Credentials for ALL admins:
--   Password: admin123
--
-- Example Logins:
--   Username: admin              | Password: admin123 | Access: All States
--   Username: admin_maharashtra  | Password: admin123 | Access: Maharashtra
--   Username: admin_delhi        | Password: admin123 | Access: Delhi
--   Username: admin_tamil_nadu   | Password: admin123 | Access: Tamil Nadu
--   ... (same for all 37 admins)
--
-- ⚠️ IMPORTANT SECURITY NOTE:
--   Change passwords immediately in production!
--   Use: UPDATE admins SET password_hash = encode(digest('new_password', 'sha256'), 'hex') 
--        WHERE username = 'admin_username';
-- ================================================================

COMMENT ON TABLE admins IS 'Administrator accounts for all Indian states and UTs with role-based access';
